var ReadPacket = React.createClass({
    ...
    getEventStatus: function getEventStatus() {
        fetch("https://www.cmapi.ca/cm_backend/index.php/api/checkout/v1/get_status_brf").then(res => res.json()).then(result => {
            // console.log(result);
    ...
    openRedPacket: function () {
        ...
        fetch("https://www.cmapi.ca/cm_backend/index.php/api/checkout/v1/try_luck_brf", {
