var ReadPacket = React.createClass({
    ...
    getEventStatus: function getEventStatus(){
      fetch(
        "https://www.cmapi.ca/cm_backend/index.php/api/checkout/v1/get_status_hm"
      )
        .then(res => res.json())
        .then(
          result => {
    ...
    openRedPacket: function() {
      ...
      fetch(
        "https://www.cmapi.ca/cm_backend/index.php/api/checkout/v1/try_luck_hm",
        {
                ...
                <div className='redpack-container' id='redpack-container'>
                    <div className='redpack'>
                        <div className='topcontent'>
                            ...
                            <h2 className='white-text'>馋猫红包雨</h2>
